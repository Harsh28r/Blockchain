...
// //    accounts = BlockchainContext.accounts;
// //    contract = BlockchainContext.contract;
// //   //  web3    = BlockchainContext.we
...
//           // toUpperCase() ye  nikala  tha idar se 
//              name={user.name}      
//              address={user.add}
  ...
  // if (data && countdict) {
    return (
     ...
     {/* {user && countdict && (
       ...
       <ProfilePageHeader
         name={user.name}
         address={user.add}    </ ProfilePageHeader>
        bloodcount={countdict}
          phone={user.no}
          // email={user.email}
           />
              ...
              <Row class="container-fluid">
                ...
                <Col className="ml-auto mr-auto" md="10"></Col>
                 <Col className="ml-auto mr-auto" md="10">
                   <Row className="collections">
              <Row style={{ justifyContent: "space-between" }}>
                 {/* data && Array.isArray(data) && data.map((val, idx) => {
                return ( */}
                      {/* <div key={idx}> */}
                            <div
                              class="card mt-1 border-5 active pb-0 px-2 shadow"
